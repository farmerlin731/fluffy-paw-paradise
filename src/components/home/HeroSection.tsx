      ...
      <div className="salon-container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-white/40 backdrop-blur-sm rounded-3xl border border-white/40 px-8 py-10 shadow-2xl inline-block">
            <h1 className="text-2xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 animate-fade-in">
              為您的毛小孩
              <br />
              提供最頂級的美容服務
            </h1>
            {/* 手機版隱藏，但保留高度 */}
            <p className="text-l md:text-xl text-gray-700 mb-8  animate-slide-in">
