...
const HeroSection = () => {
  return (
    <section className="bg-gradient-to-br from-pink-200 via-lavender-200 to-pink-100 py-20 md:py-32 relative overflow-hidden">
      <div className="salon-container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Button asChild size="lg" className="rounded-full px-8 py-6 text-lg animate-slide-in bg-primary hover:bg-primary/90 text-white shadow-lg">
            <Link to="/booking">
